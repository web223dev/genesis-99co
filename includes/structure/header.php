 ...
 * @since 2.3.43
 */
// add_action(  'wp', 'nnco_content_security_policy' );
function nnco_content_security_policy() {
...
add_action( 'genesis_doctype', 'nnco_do_doctype' );
/**
...
add_filter( 'wp_resource_hints', 'nnco_resource_hints', 10, 2 );
/**
 ...
 * @since 2.3.19
 */
function nnco_resource_hints( $hints, $relation_type ) {
...
add_action( 'wp_enqueue_scripts', 'nnco_load_assets' );
/**
...
function nnco_load_assets() {
	...
	wp_enqueue_style( 'nnco', $stylesheet_dir . $src, array(), $assets_version );
	...
	wp_enqueue_script( 'nnco', $stylesheet_dir . $src, array('jquery'), $assets_version, true );

}

// add_filter('script_loader_tag', 'nnco_script_loader_tags', 10, 2);
/**
 ...
 * @since 2.3.49
 */
function nnco_script_loader_tags( $tag, $handle ) {
...
// add_filter( 'genesis_pre_load_favicon', 'nnco_pre_load_favicon' );
/**
 * Simple favicon override to specify your favicon's location.
 *
 * @since 2.0.0
 */
function nnco_pre_load_favicon() {
...
// add_action( 'wp_head', 'nnco_load_favicons' );
/**
...
add_action( 'init', 'nnco_register_header_nav' );
function nnco_register_header_nav() {
	register_nav_menu( 'header-left', __( 'Header Left Navigation Menu', 'nnco' ) );
	register_nav_menu( 'header-right', __( 'Header Right Navigation Menu', 'nnco' ) );
	register_nav_menu( 'header-mobile', __( 'Header Mobile Navigation Menu', 'nnco' ) );
}

add_action( 'genesis_header', 'nnco_do_header_nav', 12 );
function nnco_do_header_nav() {
	//echo '<div class="header-content">';
	genesis_nav_menu( array('theme_location' => 'header-left') );
	genesis_nav_menu( array('theme_location' => 'header-right') );
	genesis_nav_menu( array('theme_location' => 'header-mobile') );
	//echo '</div>';
}
