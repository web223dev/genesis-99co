...
if( !defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	add_action( 'admin_bar_menu', 'nnco_clear_transients_node', 99 );
	/**
	 * Clear all transients with one click.
	 *
	 * @since 2.2.9
	 */
	function nnco_clear_transients_node ( $wp_admin_bar ) {
	...
	// add_action( 'admin_bar_menu', 'nnco_cron_count_node', 99 );
	/**
	 * Show the length of the scheduled cron task list.
	 *
	 * @since 2.3.15
	 */
	function nnco_cron_count_node ( $wp_admin_bar ) {
